...
export default function App() {
  ...
  //4° requisito
  const [userEmail,setUserEmail] = useState('gustavoalmeida2208@gmail.com')
  const [userName,setUserName] = useState('Gustavo Almeida Paula')
  const [userBirthday,setUserBirthday] = useState('05/09')
